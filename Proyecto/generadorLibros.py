...
for i in range(1000001, 1000501):
    ...
    ISBN = random.randint(0,9999) + random.randint(0,9999) + random.randint(0,9999) + random.randint(0,9999)
    fechaPub = str(random.randint(0,31)) + "/mayo/" + str(random.randint(1960, 2021))
    ...
    print(i, ",", nombre, ",", autor, ",", ISBN, ",", editorial, ",", random.choice(idiomas), ",", random.choice(categorias), ",", "true", ",", ejemplares)