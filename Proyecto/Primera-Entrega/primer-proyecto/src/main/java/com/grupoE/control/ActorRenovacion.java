...
public class ActorRenovacion {
    ...
    public ActorRenovacion(String opcion){
        try{
            String direccion;
            if(opcion.equals("A")){
                //Usando Hamachi A
    ...
    public static void main(String[] args) {
        ...
        ActorRenovacion ar = new ActorRenovacion(args[0]);
        // Envia las peticiones al servidor con el patrón requesr-reply
        ar.leerRenovaciones();
    }
    public void leerRenovaciones(){ 
        try{
            while(!Thread.currentThread().isInterrupted()){
                ...
                if(topico == 2){
                    ...
                    System.out.println("Actor Renovacion"+peticionAux.toString());
